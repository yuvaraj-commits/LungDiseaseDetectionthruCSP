import torch
from torchvision.models.densenet import _DenseBlock,_DenseLayer,_Transition#_bn_function_factory,
...
def csp_densenet264(growth_rate = 32,block_config = (6,32,64,48),num_init_features = 64,**kwargs):
    return _csp_densenet(growth_rate,block_config,num_init_features,**kwargs)
